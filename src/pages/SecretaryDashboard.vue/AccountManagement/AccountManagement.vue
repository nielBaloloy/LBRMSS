<template>
  <q-layout view="lHh lpR fFf" class="bg-accent">
    ...
    >
      ...
      >
        <q-item
          to="/SecretaryDashboard/Services"
          active-class="text-orange"
          exact
          @click="activeclick()"
        >
          <q-item-section avatar></q-item-section>
          <q-item-section> Add New Application </q-item-section>
        </q-item>
        <q-item
          to="/SecretaryDashboard"
          active-class="text-orange"
      ...
      >
        ...
        >
          <q-item-section avatar></q-item-section>
          <q-item-section> Priest Schedule </q-item-section>
        </q-item>
      </q-expansion-item>
      ...
      >
        ...
        >
          ...
          <q-item-section> Marriage Records </q-item-section>
        </q-item>
        <q-item
          to="/SecretaryDashboard/Account-Management"
          active-class="text-orange"
        ...
        >
          ...
          <q-item-section> Baptismal Records </q-item-section>
        </q-item>
        <q-item
          to="/SecretaryDashboard/Account-Management"
          active-class="text-orange"
        ...
        >
          ...
          <q-item-section> Burial Records </q-item-section>
        </q-item>
        <q-item
          to="/SecretaryDashboard"
          active-class="text-orange"
        ...
        >
          <q-item-section avatar></q-item-section>
          <q-item-section> Confirmation Records </q-item-section>
        </q-item>
      </q-expansion-item>
      ...
      >
        ...
        <q-item-section> Logs and Audit Trails </q-item-section>
      </q-item>
    </q-drawer>
          ...
          <q-card-section class="row items-center">
            <div class="form">
              <q-form
                ...
                @submit.prevent="submit_Account_data(AccountDataPayload)"
              >
                    ...
                    <div class="input-user" style="width: 48%">
                      ...
                      >
                        <div v-if="length == true">
                          <p class="text-red q-mb-xs">Password is too short</p>
                        </div>
