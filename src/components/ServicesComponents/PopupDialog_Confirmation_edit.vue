      ...
      <q-tab-panels v-model="tab" animated>
        ...
        <q-tab-panel name="personaldetails">
          <div
            ...
            :key="personalDetails.con_person_id"
          >
            <div class="inputStep">
              ...
              <q-input
                :dense="true"
                ref="step2Ref"
                v-model="personalDetails.con_lname"
                outlined
              />
            </div>
            ...
            <div class="inputStep">
              ...
              <q-input
                :dense="true"
                ref="step2Ref"
                v-model="personalDetails.con_fname"
                outlined
              />
            </div>
            ...
            <div class="inputStep">
              ...
              <q-input
                :dense="true"
                ref="step2Ref"
                v-model="personalDetails.con_mname"
                outlined
              />
            </div>
            ...
            <div class="inputStep">
              ...
              <q-input
                :dense="true"
                ref="step2Ref"
                v-model="personalDetails.con_suffix"
                outlined
              />
            </div>
            ...
            <div class="inputStep">
              ...
              <q-radio
                size="xs"
                v-model="personalDetails.con_gender"
                :val="1"
                label="Male"
              />
              <q-radio
            ...
            <div class="inputStep">
              ...
              <q-input
                :dense="true"
                outlined
                v-model="personalDetails.con_birth_date"
              >
                <template v-slot:append>
                  <q-icon name="event" class="cursor-pointer">
                    <q-popup-proxy
            ...
            <div class="inputStep">
              ...
              <q-input
                outlined
                v-model="personalDetails.con_birthplace"
                lazy-rules
                :dense="true"
              />
            </div>
            ...
            <div class="inputStep">
              ...
              <q-input
                outlined
                v-model="personalDetails.con_father"
                lazy-rules
                :dense="true"
              />
            </div>
            ...
            <div class="inputStep">
              ...
              <q-input
                outlined
                v-model="personalDetails.con_mother"
                lazy-rules
                :dense="true"
              />
            </div>
            ...
            <div class="inputStep">
              <p class="text-grey-9 q-mb-xs text-subtitle">Gender</p>
            ...
            <div class="inputStep">
              ...
              <div class="listStatus q-ml-md">
                <q-radio
                  name="legitimacy"
                  color="amber"
                  v-model="personalDetails.con_legitimacy"
                  :val="0"
                  label="Illegal"
                />
                <q-radio
            ...
            <div class="AddressField flex row">
              <div class="ServiceAddresss">
                ...
                <q-select
                  v-model="personalDetails.con_region"
              ...
              <div class="ServiceAddresss">
                ...
                <q-select
                  v-model="personalDetails.personalDetails"
              ...
              <div class="ServiceAddresss">
                ...
                <q-select
                  v-model="personalDetails.con_city"
                  :options="cityOptions"
                  label="City"
                  dense
                  outlined
              ...
              <div class="ServiceAddresss">
                ...
                <q-select
                  v-model="personalDetails.con_barangay"
